...
router.get('/', (req, res) => {
    ...
    let query = "SELECT ID, Img, Title, Info FROM tbl_p_card";
    ...
    sql.query(query, (err, result) => {
        ...
        // controls 'work' var on home.hbs
        res.render('home', { work: result });
    })
})
...
router.get('/work/:id', (req, res) => {
    ...
    let query = `SELECT * FROM tbl_p_info WHERE pcardID="${req.params.id}"`;
